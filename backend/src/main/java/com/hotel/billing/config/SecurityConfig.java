...
import com.hotel.billing.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/invoice/**").permitAll() // Public invoice access via QR
                        .requestMatchers("/api/admin/**").hasRole("ADMIN")
                        .requestMatchers("/api/kitchen/**").hasAnyRole("KITCHEN", "ADMIN")
                        .requestMatchers("/api/cashier/**").hasAnyRole("CASHIER", "ADMIN")
                        .requestMatchers("/api/servant/**").hasAnyRole("SERVANT", "ADMIN")
