...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    @Query("SELECT COUNT(o) FROM Order o WHERE o.createdBy.username = :username AND o.createdAt >= :startDate")
    Long countByCreatedByUsernameAndCreatedAtAfter(@Param("username") String username, @Param("startDate") LocalDateTime startDate);
}
